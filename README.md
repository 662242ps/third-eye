...
ขณะตรวจจับจริง โปรแกรมต่อไฟล์ WAV ที่เตรียมไว้ล่วงหน้า จึงไม่โหลดโมเดลเสียงหรือสังเคราะห์เสียงทุกเฟรม โมเดลใน `tts/voices/` ใช้เมื่อสร้างหรือสร้างไฟล์ segment ใหม่เท่านั้น
